	...
	<div id="wrapper">
		...
		<div class="container-fluid body-section">
			<div class="row">
				...
				<div class="col-md-9">
					<h1><i class="fas fa-folder-open"></i> Posts <small>View All Posts</small></h1><hr>
					<ol class="breadcrumb">
						<li><a href="#"><i class="fas fa-tachometer-alt"></i> Dashboard</li></a>
						<li class="active"><i class="fas fa-folder-open"></i> Users</li>
					</ol>
						...
						<table class="table table-bordered table-striped table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td><a href="edit-post.php?edit=<?php echo $id;?>"><i class="fas fa-edit"></i></a></td>
									<td><a href="posts.php?del=<?php echo $id;?>"><i class="fas fa-trash-alt"></i></a></td>
								</tr>
								<?php } ?>
							</tbody>
						</table>
